...
Khan_Percent = round((Khan_Total/Voter_Total)*100,1)
Correy_Percent = round((Correy_Total/Voter_Total)*100,1)
Li_Percent = round((Li_Total/Voter_Total)*100,1)
OTooley_Percent = round((OTooley_Total/Voter_Total)*100,1)
